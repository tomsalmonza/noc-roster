...
def validate_roster(
    ...
    fairness_components = {
        ...
        "Actual Full Weekends Off": variance([employee_summary[e]["Actual Full Weekends Off"] for e in EMPLOYEES]),
    ...
    metrics = {
        ...
        "Actual Full Weekend Off Variance": fairness_components["Actual Full Weekends Off"],
